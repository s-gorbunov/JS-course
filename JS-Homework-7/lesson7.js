...
var FOOD_SPEED = 5000; //Интервал появления еды
var PROBLEM_SPEED = 5000; //Интервал появления бомб
var snake = []; // Сама змейка
var direction = 'y+'; // Направление движения змейки
var gameIsRunning = false; // Запущена ли игра
var snake_timer; // Таймер змейки
var food_timer; // Таймер для еды
var problem_timer; // Таймер бомб
...
var points = document.getElementsByClassName('score-point')[0]; //показать счет
...
function startGame() {
    if(!gameIsRunning) {
        ...
        problem_timer = setInterval(createFood, PROBLEM_SPEED);
    }
}
...
/**problem-unit
 * Функция создания препядствий-проблем для нашей змейки
 */
function createProblem(){
    ...
    while(!problemCreated){
        ...
        var problem_cell = document.getElementsByClassName('cell-' + problem_y + '-' + problem_x);
